    ...
    <div className='p-col-12'>
      <div className='card docs'>
        ...
        <p>
          ...
          extract the contents of the zip bundle and install the dependencies
          with npm or yarn.
        </p>
        <pre>
          {`npm install
...
`}
        ...
        <p>
          ...
          to createMenu() method App.js file and define your own model as a
          nested structure. Here is the menu component from the demo
          application. Notice that menu object is bound to the model property of
          AppMenu component as shown above.
        </p>
        <pre>
          {`
createMenu() {
...
`}
        ...
        <p>
          In case you did like to customize the layout variables, open
          layout.scss file under src/layout folder. Saving the changes will be
...
`}
        ...
        <pre>&lt;div className=layout-wrapper menu-layout-overlay &gt;</pre>
        <p>
        ...
        <h1>Dark Menu</h1>
        <p>
          Default color scheme of menu is light and alternative dark mode can be
          activated by adding <i>dark-sidebar</i> style class to the sidebar
          element.
        </p>
        ...
        <p>
          It is suggested to write your customizations in <i>App.css</i> file
          instead of adding them to the scss files under sass folders to avoid
